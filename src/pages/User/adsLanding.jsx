...
export default function AdsLanding() {
  ...
  return (
    <main className="pt-20 max-w-7xl mx-auto px-6">
      <h1 className="text-4xl md:text-6xl font-extrabold text-green-900 mb-6 text-center">
        Welcome to <span className="text-green-700">sasala.lk</span>
      </h1>
      <p className="text-center text-gray-600 text-lg mb-12 max-w-2xl mx-auto">
        Buy and Sell anything in your area — fast and easy.
      </p>
